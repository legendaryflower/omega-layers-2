var game = {
    ...
    achievements: [
        ...
        new Achievement("Other Times Await... Yet Again", "Go δ", "δ", () => game.layers[3] && game.layers[3].timesReset > 0),
             new Achievement("A new beginning...", "Begin generation of ℵ", '<span class="aleph">ℵ</span>', () => game.alephLayer.aleph.gte(1)),
        ...
        new Achievement("H λ l f L i f e", "Go λ", "λ", () => game.layers[10] && game.layers[10].timesReset > 0),
                new Achievement("Aleph-∞", "Reach ~1ee100 ℵ", '<span class="aleph">ℵ<sub>Ω</sub></span>', () => game.alephLayer.aleph.gte("1ee100")),
                new Achievement("Another stack", "Restack 10 times", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.restackLayer.timesReset > 10),
         new Achievement("Tiny Omega", "Go ω", "ω", () => game.layers[24] && game.layers[24].timesReset > 0),
        ...
        new Achievement("Ω-Layers", "Reach Layer Ω", "Ω", () => game.metaLayer.layer.gte(47)),
          new Achievement("Ω-Layers with no Meta", "Reach Layer Ω without Meta", "Ω", () => game.layers[47] && game.layers[24].timesReset > 0),
           new Achievement("New Alpha", "Reach 1eee308 α", "αα", () => game.layers[0] && game.layers[0].resource.gte("1eee308")),
        ...
        new Achievement("The Ladder is Infinite", "Reach Layer 1000", "Ρ↑β", () => game.metaLayer.layer.gte(1000)),
                new Achievement("Five for each Second", "Advance 5 Layers per second", "»", () => game.metaLayer.getLayersPS().gte(5)),
        new Achievement("Stupidly fast", "Advance 10 Layer per second", "»»", () => game.metaLayer.getLayersPS().gte(10)),
                 new Achievement("Not a second lost", "Restack 100 times", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.restackLayer.timesReset > 100),
                new Achievement("You need these", "Have 1.8e308 Layer Coins", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.restackLayer.layerCoins.gte(1.8e308)),
        ...
        new Achievement("I am speed", "Advance 1e100 Layers per second", "»»»»»", () => game.metaLayer.getLayersPS().gte(1e100)),
           new Achievement("Daredevil", "Advance ~1.8e308 Layers per second", "»»»»»", () => game.metaLayer.getLayersPS().gte(INFINITY)),
        new Achievement("Faster than Sonic Boom", "Advance 1e10000 Layers per second", "⁍", () => game.metaLayer.getLayersPS().gte("1ee5")),
        new Achievement("Maximum speed", "Advance 1e1000000 Layers per second", "⁍⁍", () => game.metaLayer.getLayersPS().gte("1ee7")),
        new Achievement("The smol D sugger", "Reach Layer ∑", "∑", () => game.metaLayer.layer.gte(1e300000008)),
        new Achievement("The Moonshine", "Have 1.8ee21 Layer Coins", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.restackLayer.layerCoins.gte("1.8ee21")),
         new Achievement("Is it over?!", "Have ??? Layer Coins", "<img alt=\"LC\" class=\"inline\" src=\"images/layercoin.svg\"/>", () => game.restackLayer.layerCoins.gte()),
           new Achievement("The Outside", "Reach Layer ~1.8ee58", "<span class='flipped-v'>α</span>", () => game.metaLayer.layer.gte("1.8ee58")),
          new Achievement("The End, No", "Reach Layer ~1.8ee308", "<span class='flipped-v'>ω</span>", () => game.metaLayer.layer.gte("1.8ee308")),
              new Achievement("Further from Alpha...", "Reach Layer ~1.8eee308", "A↑ε2", () => game.metaLayer.layer.gte("1.8eee308")),
            new Achievement("The Boundary", "Reach Layer ~1.8eeee308", "<span style='font-size: 30%;'><span>A<sub>↑↑</sub></span><sup>ε</sup>↑<span>Ω<sub>Ω</sub></span><sup>Ν</sup>↑<span>Ω<sub>ϛ</sub></span><sup>κ</sup>↑<span>A↑</span><sup>2</sup></span>", () => game.metaLayer.layer.gte("1.8eeee308")),
                   new Achievement("Very Further from Alpha...", "Reach Layer ~1.8eeeee308", "<span style='font-size: 30%;'>(A↑2)ϑ69</span>", () => game.metaLayer.layer.gte("1.8eeeee308")),
               new Achievement("Almost to number limit.", "Reach Layer ~1.8eeeeeeeeee308", "<span style='font-size: 30%;'>(A↑ϑ)ϑ2</span>", () => game.metaLayer.layer.gte("1.8eeeeeeeeee308")),
    ],
    currentLayer: null,
