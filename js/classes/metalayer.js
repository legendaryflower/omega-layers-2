    ...
    constructor()
    {
        ...
        this.multiplierUpgrades = [
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                ...
                level => new Decimal(1),
                level => Decimal.pow(25, level.pow(game.restackLayer.upgradeTreeNames.resourceMultipliersLevelScaling.apply())).pow(this.getResourceMultiplierBoost())),
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(12).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(47),
                level => new Decimal(1),
                level => Decimal.pow(125, level.pow(game.restackLayer.upgradeTreeNames.resourceMultipliersLevelScaling.apply())).pow(this.getResourceMultiplierBoost())),
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(48).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(143),
                level => new Decimal(1),
                level => Decimal.pow(6125, level.pow(game.restackLayer.upgradeTreeNames.resourceMultipliersLevelScaling.apply())).pow(this.getResourceMultiplierBoost())),
              new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(256).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(975),
                level => new Decimal(1),
                level => Decimal.pow(972125, level.pow(game.restackLayer.upgradeTreeNames.resourceMultipliersLevelScaling.apply())).pow(this.getResourceMultiplierBoost())),
              new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(16384).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(3411),
                level => new Decimal(1),
                level => Decimal.pow(41792125, level.pow(game.restackLayer.upgradeTreeNames.resourceMultipliersLevelScaling.apply())).pow(this.getResourceMultiplierBoost())),
             new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                level => Utils.createValueDilation(level.mul(4194304).mul(Decimal.pow(1.1, Decimal.max(0, level.sub(15)))), 0.001).floor().add(789141),
                level => new Decimal(1),
                level => Decimal.pow(8147591782152515, level.pow(game.restackLayer.upgradeTreeNames.resourceMultipliersLevelScaling.apply())).pow(this.getResourceMultiplierBoost())),
             new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
